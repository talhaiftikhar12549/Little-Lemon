        ...
        <>
            <div className={"border h-[50vh] bg-[#495E57] w-[100%] flex vw-[80%] justify-center"}>
                    <div className={" flex-col flex w-[40%] justify-center"}>
                        ...
                        <p className={"text-lg text-[#ffffff] py-1 "}>We are a family owned Mediterranean restaurant, focused
                            on traditional recipes served with a
                            modern twist</p>
                        <div>
                            <button className={"font-semibold border border-[#F5CD14] my-8 rounded-lg bg-[#F5CD14] px-12 py-2"}>Reserve a Table</button>
                        </div>
